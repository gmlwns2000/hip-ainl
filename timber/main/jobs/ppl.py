...
def job_ppl(args, model, tokenizer: transformers.LlamaTokenizer, device, visualize):
    ...
    if not args.ensemble:
        ...
        outfile = f'./cache/llama_eval/{args.name}/ppl_{args.method}_{args.model}_s{args.stride}_dl{args.dense_layers}_k{args.k}_ckpt{args.checkpoint is not None}_ensbn{args.ensemble_model_n}_mft{args.ensemble_method_final_inter_thresh}_bmk{args.ensemble_method_final_bdd_mask_k}_lt{args.ensemble_layer_till}_r{args.ensemble_randomness}.json'
